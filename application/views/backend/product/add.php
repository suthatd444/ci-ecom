      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            ...
            <form class="forms-sample" action="<?php echo base_url('add-product'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="file" name="img" class="file-upload-default">
                <div class="input-group col-xs-12">
                  <input type="file" name="product_img" required class="form-control" placeholder="Upload Image">
                </div>
              </div>
              <div class="form-group">
