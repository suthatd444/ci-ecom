    ...
    <div class="row">
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            <h4 class="card-title">Add Industry Presence</h4>
            <form class="forms-sample" action="<?php echo base_url('add-industry-presence'); ?>" method="post" enctype="multipart/form-data">
