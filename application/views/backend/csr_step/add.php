    ...
    <div class="row">
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            <h4 class="card-title">Add CSR Step</h4>
            <form class="forms-sample" action="<?php echo base_url('add-csrstep'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                  <input type="file" name="csr_step_img" required class="form-control" placeholder="Upload Image">
                </div>
              </div>
              <div class="form-group">
