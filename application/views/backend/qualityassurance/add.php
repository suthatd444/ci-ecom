    ...
    <div class="row">
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            <h4 class="card-title">Add Inspection Testing</h4>
            <form class="forms-sample" action="<?php echo base_url('add-inspection-testing'); ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>File upload</label>
                <input type="file" name="img" class="file-upload-default">
                <div class="input-group col-xs-12">
                  <input type="file" name="inspection_testing_image" required class="form-control" placeholder="Upload Image">
                </div>
              </div>
              <div class="form-group">
