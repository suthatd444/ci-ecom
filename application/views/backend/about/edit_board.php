      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            ...
            <form class="forms-sample" action="<?php echo base_url('edit-board?id=').$board['id']; ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?= $board['id'] ?>">
              <div class="form-group">
                <label for="exampleTextarea1">IS PRIMARY</label>
                <input type="checkbox" name="is_primary" <?php echo !empty($board['is_primary']=="YES")?"checked":"" ?>/>
              ...
              <div class="form-group">
                   <img src="<?= base_url('./uploads/').$board['image']?>" style="width: 10%;height: 10%;">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" required name="main_desc" id="editor1" rows="4"><?= $board['main_desc'] ?></textarea>
              </div>
