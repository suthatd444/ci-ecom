    ...
    <div class="row">
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <?php } ?>
            <h4 class="card-title">Add Integrity</h4>
            <form class="forms-sample" action="<?php echo base_url('add-integrity'); ?>" method="post" enctype="multipart/form-data">
             
              <div class="form-group">
                <label>Image</label>
                <input type="file" name="img" class="file-upload-default">
                <div class="input-group col-xs-12">
                  <input type="file" name="integrity_img" required class="form-control" placeholder="Upload Image">
                </div>
              </div>
              <!-- <div class="form-group">
